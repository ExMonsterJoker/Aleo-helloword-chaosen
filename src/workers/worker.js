...
async function deployProgram(program) {
  ...
  const account = new Account({
    privateKey: "APrivateKey1zkp9fwBvQcKB2x7L9eXhFia74PXagZHUYAWyQeAUx5xSWbn",
  });
  ...
  const feeRecord = "{owner: aleo1w6gzp94rn4f8wmrhvu2hsjk24c4qzn2zlttvtc2qxq5wqm8vzy9qjmqr0g.private, microcredits: 1000000u64.private, _nonce: 1338149045256546904870150973533697929010294167033420454730948861611032822901group.public}";
  const tx_id = await programManager.deploy(program, fee, undefined, feeRecord);
